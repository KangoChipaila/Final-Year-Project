        ...
        data.forEach(function(object)
        {
            ...
            table_row.classList.add("bg-white");
             ...
             table_row.innerHTML = "<th scope='row' class='px-6 py-4 font-medium whitespace-nowrap'>" + object.asset_name + "</th>" +
                ...
                "<td class='px-6 py-4 text-center'>" + (object.barcode_number || `<button class = "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="generateBarcodeNumber('${(object.asset_name)}')">Generate Barcode</button>`) + "</td>" + 
